...
cornucopia_async::Params<'a, CreateParams<>, std::pin::Pin<Box<dyn futures::Future<Output = Result<u64,
tokio_postgres::Error>> + Send + 'a>>, C> for CreateStmt
{
    fn
    params(&'a mut self, client: &'a  C, params: &'a
    CreateParams<>) -> std::pin::Pin<Box<dyn futures::Future<Output = Result<u64,
