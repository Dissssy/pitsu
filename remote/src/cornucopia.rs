...
pub mod types {
    pub mod public {
        ...
        impl<'a> postgres_types::ToSql for AccessLevel {
            fn to_sql(
                &self,
...
pub mod queries {
    pub mod access {
        ...
        pub struct CreateParams {
            ...
            pub access_level: super::super::types::public::AccessLevel,
        }
        #[derive(Clone, Copy, Debug)]
        ...
        pub struct DeleteByUserUuidAndRepositoryUuidQuery<'a, C: GenericClient, T, const N: usize> {
            ...
            extractor: fn(&tokio_postgres::Row) -> DeleteByUserUuidAndRepositoryUuid,
            ...
            C: GenericClient,
        {
            pub fn map<R>(
                self,
                mapper: fn(DeleteByUserUuidAndRepositoryUuid) -> R,
        ...
        pub struct SuperSuperTypesPublicAccessLevelQuery<'a, C: GenericClient, T, const N: usize> {
            ...
            params: [&'a (dyn postgres_types::ToSql + Sync); N],
            stmt: &'a mut cornucopia_async::private::Stmt,
            extractor: fn(&tokio_postgres::Row) -> super::super::types::public::AccessLevel,
            mapper: fn(super::super::types::public::AccessLevel) -> T,
        }
        impl<'a, C, T: 'a, const N: usize> SuperSuperTypesPublicAccessLevelQuery<'a, C, T, N>
        where
            C: GenericClient,
        {
            pub fn map<R>(
                self,
                mapper: fn(super::super::types::public::AccessLevel) -> R,
        ...
        pub struct GetByUserQuery<'a, C: GenericClient, T, const N: usize> {
            ...
            params: [&'a (dyn postgres_types::ToSql + Sync); N],
            stmt: &'a mut cornucopia_async::private::Stmt,
            extractor: fn(&tokio_postgres::Row) -> GetByUser,
        ...
        where
            C: GenericClient,
        {
            pub fn map<R>(self, mapper: fn(GetByUser) -> R) -> GetByUserQuery<'a, C, R, N> {
                GetByUserQuery {
                    client: self.client,
                    params: self.params,
                    stmt: self.stmt,
    ...
    VALUES ($1, $2, $3)",
        ...
        impl CreateStmt {
            pub async fn bind<'a, C: GenericClient>(
                ...
                access_level: &'a super::super::types::public::AccessLevel,
        ...
        impl DeleteByUserUuidAndRepositoryUuidStmt {
            ...
            ) -> DeleteByUserUuidAndRepositoryUuidQuery<'a, C, DeleteByUserUuidAndRepositoryUuid, 2>
            {
                DeleteByUserUuidAndRepositoryUuidQuery {
                    ...
                    stmt: &mut self.0,
                    extractor: |row| DeleteByUserUuidAndRepositoryUuid {
                        uuid: row.get(0),
...
WHERE r.uuid = $2",
        ...
        impl UserHasAccessStmt {
            pub fn bind<'a, C: GenericClient>(
                ...
                'a,
                C,
                super::super::types::public::AccessLevel,
                2,
            > {
                SuperSuperTypesPublicAccessLevelQuery {
                    client,
    ...
    pub mod user {
        ...
        pub struct CreateQuery<'a, C: GenericClient, T, const N: usize> {
            ...
            params: [&'a (dyn postgres_types::ToSql + Sync); N],
            stmt: &'a mut cornucopia_async::private::Stmt,
            extractor: fn(&tokio_postgres::Row) -> CreateBorrowed,
            mapper: fn(CreateBorrowed) -> T,
        }
        impl<'a, C, T: 'a, const N: usize> CreateQuery<'a, C, T, N>
        where
            C: GenericClient,
        {
            pub fn map<R>(self, mapper: fn(CreateBorrowed) -> R) -> CreateQuery<'a, C, R, N> {
                CreateQuery {
                    client: self.client,
                    params: self.params,
                    stmt: self.stmt,
    ...
    RETURNING *",
        ...
        impl CreateStmt {
            pub fn bind<'a, C: GenericClient, T1: cornucopia_async::StringSql>(
                ...
                client: &'a C,
                username: &'a T1,
            ) -> CreateQuery<'a, C, Create, 1> {
                CreateQuery {
                    client,
                    params: [username],
                    stmt: &mut self.0,
                    extractor: |row| CreateBorrowed {
                        uuid: row.get(0),
                        username: row.get(1),
                        api_key: row.get(2),
